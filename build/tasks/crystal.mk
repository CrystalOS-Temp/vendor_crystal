...
CRYSTAL_TARGET_PACKAGE := $(PRODUCT_OUT)/CrystalOS-$(CRYSTAL_VERSION)-$(CRYSTAL_VERSION_NAME)-Android$(PLATFORM_VERSION)-$(CRYSTAL_BUILD_TYPE)-$(CRYSTAL_DEVICE)-$(CRYSTAL_PURITY)-$(CRYSTAL_BUILD_DATE)-$(CRYSTAL_BUILD_HOUR)$(CRYSTAL_BUILD_MINUTES).zip
